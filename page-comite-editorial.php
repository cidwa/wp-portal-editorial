...
<body>
    ...
    <div class="container" data-example-id="collapse-accordion">
        ...
        <div >
            ...
            <a id="lineamientos-2" img href="pdf/Lineamientos_Comite.pdf" target="_blank" ><img src="img/pdf.png" alt="Smiley face" height="30" width="30"></a>
...
Anexo 3: Ruta crítica para publicación        </a>
    ...
    <script>
        ...
        PDFObject.embed("/pdf/Lineamientos_Comite.pdf", "#pdf1", options);
    </script>
