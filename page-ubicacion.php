...
?>
    ...
    <div class="container">
        <div class="row">
            <h2 class="media-heading">UBICACION DE LA FES ACATLAN</h2> 
            <br><br>
            <div class="col-md-8 col-sm-7">
                ...
                <div class="col-md-4 col-sm-5">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Croquis</h3>
                            <p>Este croquis es para llegar a la FES ACATLAN</p>
                        </div>
                    </div>
                </div>
        </div>
    ...
    <section class="container">
            ...
            <div class="col-xs-12">
                  <h2 class="text-center">Ubicacion de la libreria dentro de la FES ACATLAN</h2>
                  <br>
            </div>
